...
COMMANDS = [
    ...
    {"name": "agent mcp", "group": "Act",
     "summary": "Expose Bob's tools over MCP (stdio, or Streamable HTTP with --http)",
     "args": "[--http] [--host H] [--port N]", "handler": "agent_mcp"},
    ...
    {"name": "code index", "group": "Act", "summary": "Build the semantic code index (embeddings) for code_search",
     "args": "[--rebuild]", "handler": "code_index"},
    ...
    {"name": "aider", "group": "Act", "summary": "Start aider in the current folder with Bob's config (opt-in: bob aider-setup)",
    ...
    {"name": "setup-voice", "group": "Setup", "summary": "Install the faster-whisper STT model + audio deps and the piper TTS voice",
     "args": "[--force]", "handler": "setup-voice"},
    {"name": "fabric-setup", "group": "Setup", "summary": "Opt-in: build Fabric and point it at the local endpoint",
    ...
    {"name": "build", "group": "Setup", "summary": "Install the llama.cpp engine (prebuilt, or --from-source; --cpu for no-GPU)",
     "args": "[--cpu] [--force] [--from-source]", "handler": "build"},
    {"name": "update", "group": "Setup", "summary": "Update Bob and its engines, then restart the endpoint",
     "args": "[--tag <ref>] [--channel stable|latest] [--from-source] [--no-restart]", "handler": "update"},
