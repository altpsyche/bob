...
COMMANDS = [
    ...
    {"name": "skill", "group": "Act", "summary": "List or run a skill (sub-agent skills need Module O)",
     "args": "[name] [--show]", "runtime": "python", "handler": "skill"},
    ...
    {"name": "stop", "group": "Run", "summary": "Stop all services (frees VRAM)",
     "args": "", "runtime": "pwsh", "handler": None},
    {"name": "down", "group": "Run", "summary": "Stop services (alias of stop)",
     "args": "", "runtime": "pwsh", "handler": None, "hidden": True},
    ...
    {"name": "logs", "group": "Run", "summary": "Tail the server log",
     "args": "[-n N]", "runtime": "pwsh", "handler": None},
    {"name": "services", "group": "Run", "summary": "Docker services: Langfuse / SearXNG / n8n",
     "args": "<start|stop|status|logs>", "runtime": "pwsh", "handler": None},
    ...
    {"name": "fabric-setup", "group": "Config", "summary": "Install Fabric and point it at the local endpoint",
     "args": "", "runtime": "pwsh", "handler": None},
    {"name": "gen", "group": "Config", "summary": "Regenerate runtime configs from models.psd1",
     "args": "", "runtime": "pwsh", "handler": None},
